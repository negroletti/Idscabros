                    ...
                    <div class="col-md-12 mx-auto">
                        <table class= "table table-bordered" id="usuarios">
                            <thead class="thead-dark">
                                ...
                                <tbody>
                                    <a href='Agregar_Inventario.php'><button>Agregar inventario</button></a>
                                    <hr>
                                    <?php
                                        $query= "SELECT Id_Inventario, Id_Proyecto, Nombre_Proyecto FROM Proyecto";
                                        ...
                                        while($row = mysqli_fetch_array($result_inventario)) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="Ver_Inventario.php?id=<?php echo $row['Id_Inventario'];?>" class= "btn btn-primary">Ver inventario</a>
