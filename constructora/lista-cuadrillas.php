                        ...
                        <table class= "table table-bordered" id="usuarios">
                            ...
                            <thead class="thead-dark">
                                ...
                                <tbody>
                                    ...
                                    <a href='Agregar_cuadrilla.php'><button class="btn btn-primary">Agregar Cuadrilla</button></a>
                                    <hr>
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_array($result_cuadrilla)) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="Eliminar_cuadrilla.php?id=<?php echo $row['Id_Cuadrilla'] ?>" class="btn btn-primary">Eliminar Cuadrilla </a>
                                                </td>
